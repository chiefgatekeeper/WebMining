...
checkboxes = driver.find_elements(By.XPATH, '//*[@id="devSearchForm"]/div[2]/div/div[1]/dl[1]/dd[2]/div[1]/div/div/dl/dd/div[1]/ul/li[1]/label')
...
companies = driver.find_elements(By.CSS_SELECTOR, '.tplList.tplJobList')
